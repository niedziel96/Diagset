...
class TrainerVIT:
    ...
    def __init__(self, model, model_config, train_dataset, train_dataset_len, test_dataset, test_dataset_len, config, weight_decay,
                 opt_type, decay_step, decay_rate, momentum):
        ...
        with self.strategy.scope():
            ...
            if self.opt_type == 'adam':
                ...
                self.optimizer = tf.keras.optimizers.experimental.SGD(learning_rate=lr_schedule, momentum=self.momentum)
